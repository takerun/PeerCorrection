...
save_param_dir = '../result/inferred_parameter/PC2'

# function
def recordPC2Info(hyper_list, model_file, csv_file):
...
class PC2:
    def __init__(self, groundtruth_DataFrame, review_DataFrame):
        ...
        self.stanmodel = pystan.StanModel(file=PC2_path)
    ...
    def corrcoefWithTruth(self,hyper_list):
        ...
        if RECORD == True:
            ...
            # record table
            recordPC2Info(hyper_list,pkl_name,os.path.join(save_param_dir,'models.csv'))
        # calculate corrcoef
