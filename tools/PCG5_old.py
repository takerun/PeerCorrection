...
# path information
PCG5_path = '../models/PCG5_old_vector.stan'
...
class PCG5:
    def __init__(self, groundtruth_DataFrame, review_DataFrame):
        ...
        self.sender = self.rDF['sender_id'].get_values().astype(np.int64) +1
        self.receiver = self.rDF['receiver_id'].get_values().astype(np.int64) +1
