...
# path information
PG4PC2a_path = '../models/PG4PC2a.stan'
save_param_dir = '../result/inferred_parameter/PG4PC2a'

# function
def recordPG4PC2aInfo(hyper_list, model_file, csv_file):
...
class PG4PC2a:
    def __init__(self, groundtruth_DataFrame, review_DataFrame):
        ...
        self.stanmodel = pystan.StanModel(file=PG4PC2a_path)
    ...
    def corrcoefWithTruth(self,hyper_list):
        ...
        if RECORD == True:
            ...
            # save
            pkl_name = 'PG4PC2a-{}.pkl'.format(timeStamp())
            saveStanExtract(parameters, os.path.join(save_param_dir,pkl_name))
            # record table
            recordPG4PC2aInfo(hyper_list,pkl_name,os.path.join(save_param_dir,'models.csv'))
        # calculate corrcoef
