...
# path information
PG1PC2a_path = '../models/PG1PC2a.stan'
save_param_dir = '../result/inferred_parameter/PG1PC2a'

# function
def recordPG1PC2aInfo(hyper_list, model_file, csv_file):
...
class PG1PC2a:
    def __init__(self, groundtruth_DataFrame, review_DataFrame):
        ...
        self.stanmodel = pystan.StanModel(file=PG1PC2a_path)
    ...
    def corrcoefWithTruth(self,hyper_list):
        ...
        if RECORD == True:
            ...
            # save
            pkl_name = 'PG1PC2a-{}.pkl'.format(timeStamp())
            saveStanExtract(parameters, os.path.join(save_param_dir,pkl_name))
            # record table
            recordPG1PC2aInfo(hyper_list,pkl_name,os.path.join(save_param_dir,'models.csv'))
        # calculate corrcoef
