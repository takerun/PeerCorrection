...
# path information
PG3PC2a_path = '../models/PG3PC2a.stan'
save_param_dir = '../result/inferred_parameter/PG3PC2a'

# function
def recordPG3PC2aInfo(hyper_list, model_file, csv_file):
...
class PG3PC2a:
    def __init__(self, groundtruth_DataFrame, review_DataFrame):
        ...
        self.stanmodel = pystan.StanModel(file=PG3PC2a_path)
    ...
    def corrcoefWithTruth(self,hyper_list):
        ...
        if RECORD == True:
            ...
            # save
            pkl_name = 'PG3PC2a-{}.pkl'.format(timeStamp())
            saveStanExtract(parameters, os.path.join(save_param_dir,pkl_name))
            # record table
            recordPG3PC2aInfo(hyper_list,pkl_name,os.path.join(save_param_dir,'models.csv'))
        # calculate corrcoef
